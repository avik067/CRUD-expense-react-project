...
class Edit extends Component {
    ...
    submitData = async (event) => {
      ...
      if (window.confirm(`Are you sure want to change parmanently 🤷‍♂️?`)) {  // we can also use react confirm package , but here we using browser native confirm that is why 
